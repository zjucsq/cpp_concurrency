...
TEST(LockFreeQueueTest, DISABLED_SampleTest) {
...
TEST(LockFreeArrayQueueTest, SampleTest) {
    lock_free_queue_array<int> queue{c.size};
...
TEST(LockFreeArrayQueueTest, SPSCTest) {
    lock_free_queue_array<int> queue{1000};
...
TEST(LockFreeArrayQueueTest, SPMCTest) {
    lock_free_queue_array<int> queue{1000};
...
TEST(LockFreeArrayQueueTest, MPSCTest) {
    lock_free_queue_array<int> queue{1000};
...
TEST(LockFreeArrayQueueTest, MPMCTest) {
    lock_free_queue_array<int> queue{1000};
